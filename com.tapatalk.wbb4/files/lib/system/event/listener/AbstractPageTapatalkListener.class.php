...
class AbstractPageTapatalkListener implements IEventListener {
	...
	public function execute($eventObj, $className, $eventName) {
		...
		$app_ios_id = StringUtil::trim(WBB_TAPATALK_APP_IOS_ID);
		$app_android_id = StringUtil::trim(WBB_TAPATALK_APP_ANDROID_ID);
		$app_kindle_url = StringUtil::trim(WBB_TAPATALK_APP_KINDLE_URL);
